...
from ultralytics.nn.modules.maf import RepHMS,AVG
from ultralytics.nn.modules.AFPN import ASFF2,ASFF3
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        # ===================================
            ...
            m = m(*args)
            c2 = m.channel
        elif m is Backbone_RVSSM2:
            m = m(*args)
            c2 = m.channel
        elif m is Backbone_Imamba:
            m = m(*args)
            c2 = m.channel
        elif m is Backbone_CSSM:
            m = m(*args)
            c2 = m.channel
        else:
            c2 = ch[f]
